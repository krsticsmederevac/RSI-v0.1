...
if usdt_btc :
    try:
        ...
        ax4.tick_params(top=True, labeltop=True, bottom=False, labelbottom=True)
        ax4.set_xticklabels(ax4.get_xticklabels(), rotation=90, ha='center',horizontalalignment="center")
        ax4.set_xlabel('SMA')
