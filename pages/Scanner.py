...
if usdt_btc :
    try:
        ...
        sns.heatmap(dt_ema, cmap ='RdYlGn',vmin=-15, vmax=15,  linewidths = 0.30, annot = False, cbar=False).set_title("EMA 10 20 100 200")
        ...
        sns.heatmap(dt5, cmap ='RdYlGn',vmin=-1.5, vmax=1.5,  linewidths = 0.30, annot = False, cbar=False).set_title("Bollinger Bands Hit")
